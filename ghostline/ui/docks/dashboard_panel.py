...
class DashboardPanel(QDockWidget):
    def __init__(
        ...
        self.architecture_health = QLabel("Architecture: unknown")
        self.runtime_status = QLabel("Runtime: idle")
        self.agent_activity = QLabel("Agents: idle")
        ...
        layout.addWidget(self.architecture_health)
        layout.addWidget(self.runtime_status)
        layout.addWidget(self.agent_activity)
